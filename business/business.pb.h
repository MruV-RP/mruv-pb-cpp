...
inline void Business::set_description(const char* value, size_t size) {
...
inline void CreateBusinessRequest::set_name(const char* value, size_t size) {
...
inline void CreateBusinessRequest::set_description(const char* value, size_t size) {
