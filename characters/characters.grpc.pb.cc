...
::grpc::ClientAsyncResponseReader< ::mruv::characters::CreateCharacterResponse>* MruVCharactersService::Stub::PrepareAsyncCreateCharacterRaw(::grpc::ClientContext* context, const ::mruv::characters::CreateCharacterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::CreateCharacterResponse>::Create(channel_.get(), cq, rpcmethod_CreateCharacter_, context, request, false);
}
...
::grpc::ClientAsyncResponseReader< ::mruv::characters::GetCharacterResponse>* MruVCharactersService::Stub::PrepareAsyncGetCharacterRaw(::grpc::ClientContext* context, const ::mruv::characters::GetCharacterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::GetCharacterResponse>::Create(channel_.get(), cq, rpcmethod_GetCharacter_, context, request, false);
}
...
::grpc::ClientAsyncResponseReader< ::mruv::characters::UpdateCharacterResponse>* MruVCharactersService::Stub::PrepareAsyncUpdateCharacterRaw(::grpc::ClientContext* context, const ::mruv::characters::UpdateCharacterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::UpdateCharacterResponse>::Create(channel_.get(), cq, rpcmethod_UpdateCharacter_, context, request, false);
}
...
::grpc::ClientAsyncResponseReader< ::mruv::characters::DeleteCharacterResponse>* MruVCharactersService::Stub::PrepareAsyncDeleteCharacterRaw(::grpc::ClientContext* context, const ::mruv::characters::DeleteCharacterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::DeleteCharacterResponse>::Create(channel_.get(), cq, rpcmethod_DeleteCharacter_, context, request, false);
}
...
::grpc::ClientAsyncResponseReader< ::mruv::characters::CharacterID>* MruVCharactersService::Stub::PrepareAsyncPermanentCharacterKillRaw(::grpc::ClientContext* context, const ::mruv::characters::CharacterID& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::CharacterID>::Create(channel_.get(), cq, rpcmethod_PermanentCharacterKill_, context, request, false);
}
...
::grpc::ClientAsyncResponseReader< ::mruv::characters::ChangeClothesResponse>* MruVCharactersService::Stub::PrepareAsyncChangeClothesRaw(::grpc::ClientContext* context, const ::mruv::characters::ChangeClothesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::mruv::characters::ChangeClothesResponse>::Create(channel_.get(), cq, rpcmethod_ChangeClothes_, context, request, false);
}
...
::grpc::ClientReader< ::mruv::characters::DeathStreamResponse>* MruVCharactersService::Stub::DeathsStreamRaw(::grpc::ClientContext* context, const ::mruv::characters::DeathStreamRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::mruv::characters::DeathStreamResponse>::Create(channel_.get(), rpcmethod_DeathsStream_, context, request);
}
...
void MruVCharactersService::Stub::experimental_async::DeathsStream(::grpc::ClientContext* context, ::mruv::characters::DeathStreamRequest* request, ::grpc::experimental::ClientReadReactor< ::mruv::characters::DeathStreamResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::mruv::characters::DeathStreamResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_DeathsStream_, context, request, reactor);
}
...
::grpc::ClientAsyncReader< ::mruv::characters::DeathStreamResponse>* MruVCharactersService::Stub::AsyncDeathsStreamRaw(::grpc::ClientContext* context, const ::mruv::characters::DeathStreamRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mruv::characters::DeathStreamResponse>::Create(channel_.get(), cq, rpcmethod_DeathsStream_, context, request, true, tag);
}
...
::grpc::ClientAsyncReader< ::mruv::characters::DeathStreamResponse>* MruVCharactersService::Stub::PrepareAsyncDeathsStreamRaw(::grpc::ClientContext* context, const ::mruv::characters::DeathStreamRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mruv::characters::DeathStreamResponse>::Create(channel_.get(), cq, rpcmethod_DeathsStream_, context, request, false, nullptr);
}

::grpc::Status MruVCharactersService::Stub::GetServiceStatus(::grpc::ClientContext* context, const ::mruv::common::ServiceStatusRequest& request, ::mruv::common::ServiceStatusResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetServiceStatus_, context, request, response);
}

void MruVCharactersService::Stub::experimental_async::GetServiceStatus(::grpc::ClientContext* context, const ::mruv::common::ServiceStatusRequest* request, ::mruv::common::ServiceStatusResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetServiceStatus_, context, request, response, std::move(f));
}

void MruVCharactersService::Stub::experimental_async::GetServiceStatus(::grpc::ClientContext* context, const ::mruv::common::ServiceStatusRequest* request, ::mruv::common::ServiceStatusResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::mruv::common::ServiceStatusResponse>* MruVCharactersService::Stub::PrepareAsyncGetServiceStatusRaw(::grpc::ClientContext* context, const ::mruv::common::ServiceStatusRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::mruv::common::ServiceStatusResponse>* MruVCharactersService::Stub::AsyncGetServiceStatusRaw(::grpc::ClientContext* context, const ::mruv::common::ServiceStatusRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status MruVCharactersService::Stub::GetServiceVersion(::grpc::ClientContext* context, const ::mruv::common::VersionRequest& request, ::mruv::common::VersionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetServiceVersion_, context, request, response);
}

void MruVCharactersService::Stub::experimental_async::GetServiceVersion(::grpc::ClientContext* context, const ::mruv::common::VersionRequest* request, ::mruv::common::VersionResponse* response, std::function<void(::grpc::Status)> f) {
...
void MruVCharactersService::Stub::experimental_async::GetServiceVersion(::grpc::ClientContext* context, const ::mruv::common::VersionRequest* request, ::mruv::common::VersionResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::mruv::common::VersionResponse>* MruVCharactersService::Stub::PrepareAsyncGetServiceVersionRaw(::grpc::ClientContext* context, const ::mruv::common::VersionRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::mruv::common::VersionResponse>* MruVCharactersService::Stub::AsyncGetServiceVersionRaw(::grpc::ClientContext* context, const ::mruv::common::VersionRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
MruVCharactersService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< MruVCharactersService::Service, ::mruv::characters::DeathStreamRequest, ::mruv::characters::DeathStreamResponse>(
          [](MruVCharactersService::Service* service,
             ...
             ::grpc::ServerWriter<::mruv::characters::DeathStreamResponse>* writer) {
               return service->DeathsStream(ctx, req, writer);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      MruVCharactersService_method_names[7],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MruVCharactersService::Service, ::mruv::common::ServiceStatusRequest, ::mruv::common::ServiceStatusResponse>(
          [](MruVCharactersService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MruVCharactersService::Service, ::mruv::common::VersionRequest, ::mruv::common::VersionResponse>(
          [](MruVCharactersService::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status MruVCharactersService::Service::GetServiceStatus(::grpc::ServerContext* context, const ::mruv::common::ServiceStatusRequest* request, ::mruv::common::ServiceStatusResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status MruVCharactersService::Service::GetServiceVersion(::grpc::ServerContext* context, const ::mruv::common::VersionRequest* request, ::mruv::common::VersionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
