...
inline bool OfferType_Parse(
    const std::string& name, OfferType* value) {
...
inline void CreateOfferRequest::set_name(const char* value, size_t size) {
...
inline void CreateOfferRequest::set_description(const char* value, size_t size) {
...
inline void CreateOfferRequest::_internal_set_offer(const std::string& value) {
  ...
  offer_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void CreateOfferRequest::set_offer(const char* value) {
  ...
  offer_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mruv.offers.CreateOfferRequest.offer)
}
inline void CreateOfferRequest::set_offer(const char* value, size_t size) {
  
  offer_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* CreateOfferRequest::_internal_mutable_offer() {
  ...
  return offer_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* CreateOfferRequest::release_offer() {
  ...
  return offer_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void CreateOfferRequest::set_allocated_offer(std::string* offer) {
  ...
  offer_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), offer);
