...
#ifndef GRPC_texturestudio_2ftexturestudio_2eproto__INCLUDED
#define GRPC_texturestudio_2ftexturestudio_2eproto__INCLUDED
...
class TextureStudioService final {
 public:
  static constexpr char const* service_full_name() {
    return "texture_studio.TextureStudioService";
  }
  class StubInterface {
   public:
  ...
  typedef WithAsyncMethod_CreateServer<WithAsyncMethod_MyServer<WithAsyncMethod_DeleteServer<WithAsyncMethod_StartServer<WithAsyncMethod_StopServer<WithAsyncMethod_RestartServer<WithAsyncMethod_ServerStatus<WithAsyncMethod_UploadProject<WithAsyncMethod_GetProject<WithAsyncMethod_GetProjects<WithAsyncMethod_SubscribeToProjectsChanges<Service > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_CreateServer<ExperimentalWithCallbackMethod_MyServer<ExperimentalWithCallbackMethod_DeleteServer<ExperimentalWithCallbackMethod_StartServer<ExperimentalWithCallbackMethod_StopServer<ExperimentalWithCallbackMethod_RestartServer<ExperimentalWithCallbackMethod_ServerStatus<ExperimentalWithCallbackMethod_UploadProject<ExperimentalWithCallbackMethod_GetProject<ExperimentalWithCallbackMethod_GetProjects<ExperimentalWithCallbackMethod_SubscribeToProjectsChanges<Service > > > > > > > > > > > CallbackService;
  #endif
  ...
  typedef WithStreamedUnaryMethod_CreateServer<WithStreamedUnaryMethod_MyServer<WithStreamedUnaryMethod_DeleteServer<WithStreamedUnaryMethod_StartServer<WithStreamedUnaryMethod_StopServer<WithStreamedUnaryMethod_RestartServer<WithStreamedUnaryMethod_ServerStatus<WithStreamedUnaryMethod_UploadProject<WithStreamedUnaryMethod_GetProject<WithStreamedUnaryMethod_GetProjects<Service > > > > > > > > > > StreamedUnaryService;
  template <class BaseClass>
...
#endif  // GRPC_texturestudio_2ftexturestudio_2eproto__INCLUDED
