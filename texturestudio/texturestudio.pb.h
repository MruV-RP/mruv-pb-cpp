...
#ifndef GOOGLE_PROTOBUF_INCLUDED_texturestudio_2ftexturestudio_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_texturestudio_2ftexturestudio_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_texturestudio_2ftexturestudio_2eproto
...
struct TableStruct_texturestudio_2ftexturestudio_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_texturestudio_2ftexturestudio_2eproto;
...
enum ProjectFormat : int {
  UNKNOWN_FORMAT = 0,
  DB_FILE = 1,
  CREATE_OBJECT = 2,
  CREATE_DYNAMIC_OBJECT = 3,
  ProjectFormat_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ProjectFormat_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ProjectFormat_IsValid(int value);
constexpr ProjectFormat ProjectFormat_MIN = UNKNOWN_FORMAT;
constexpr ProjectFormat ProjectFormat_MAX = CREATE_DYNAMIC_OBJECT;
constexpr int ProjectFormat_ARRAYSIZE = ProjectFormat_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ProjectFormat_descriptor();
template<typename T>
inline const std::string& ProjectFormat_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ProjectFormat>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ProjectFormat_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ProjectFormat_descriptor(), enum_t_value);
}
inline bool ProjectFormat_Parse(
    const std::string& name, ProjectFormat* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ProjectFormat>(
    ProjectFormat_descriptor(), name, value);
}
// ===================================================================
...
class CreateServerRequest :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_texturestudio_2ftexturestudio_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_texturestudio_2ftexturestudio_2eproto;
};
// -------------------------------------------------------------------
...
class UploadProjectRequest :
 ...
 public:
  ...
  void clear_project_format();
  ::texture_studio::ProjectFormat project_format() const;
  void set_project_format(::texture_studio::ProjectFormat value);
  private:
  ::texture_studio::ProjectFormat _internal_project_format() const;
  void _internal_set_project_format(::texture_studio::ProjectFormat value);
  public:
...
// .texture_studio.ProjectFormat project_format = 3;
inline void UploadProjectRequest::clear_project_format() {
  project_format_ = 0;
}
inline ::texture_studio::ProjectFormat UploadProjectRequest::_internal_project_format() const {
  return static_cast< ::texture_studio::ProjectFormat >(project_format_);
}
inline ::texture_studio::ProjectFormat UploadProjectRequest::project_format() const {
  // @@protoc_insertion_point(field_get:texture_studio.UploadProjectRequest.project_format)
  return _internal_project_format();
}
inline void UploadProjectRequest::_internal_set_project_format(::texture_studio::ProjectFormat value) {
  
  project_format_ = value;
}
inline void UploadProjectRequest::set_project_format(::texture_studio::ProjectFormat value) {
  _internal_set_project_format(value);
  // @@protoc_insertion_point(field_set:texture_studio.UploadProjectRequest.project_format)
}
...
// bool success = 1;
inline void UploadProjectResponse::clear_success() {
  success_ = false;
}
inline bool UploadProjectResponse::_internal_success() const {
  return success_;
}
inline bool UploadProjectResponse::success() const {
  // @@protoc_insertion_point(field_get:texture_studio.UploadProjectResponse.success)
  return _internal_success();
}
inline void UploadProjectResponse::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void UploadProjectResponse::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:texture_studio.UploadProjectResponse.success)
}
...
template <> struct is_proto_enum< ::texture_studio::ProjectFormat> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::texture_studio::ProjectFormat>() {
  return ::texture_studio::ProjectFormat_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_texturestudio_2ftexturestudio_2eproto
