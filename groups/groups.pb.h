...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetGroupsRequest::_internal_limit() const {
  return limit_;
}
...
inline void GetGroupsRequest::_internal_set_limit(::PROTOBUF_NAMESPACE_ID::int32 value) {
